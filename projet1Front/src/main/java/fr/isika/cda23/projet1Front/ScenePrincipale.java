...
public class ScenePrincipale {
	...
	public ScenePrincipale() throws IOException {
		...
		Label lblFormulaireStagiaire = new Label("Fomulaire Stagiaire");
			...
			public void handle(ActionEvent event) {
				try {
					ChargeurArbreBinaire chargeur = new ChargeurArbreBinaire(
							...
							departementBox.getValue(),
							textFieldPromotion.getText(), 
							spinnerAnneeScolaire.getValue().toString());
		...
		boutonModifier.setFont(Font.font("Brush Script MT", 14));
		boutonModifier.setTranslateY(100);

		Button boutonSupprimer = new Button("Supprimer");
		boutonSupprimer.setFont(Font.font("Brush Script MT", 14));
		boutonSupprimer.setTranslateX(155);
		boutonSupprimer.setTranslateZ(110);
		boutonSupprimer.setTranslateY(70);
		...
		boutonSupprimer.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				table.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
				    if (newValue != null) {
				        System.out.println("Ligne sélectionnée : " + newValue);
				    }
				});
...
//				System.out.println(departementBox.getValue());
//				System.out.println(textFieldPromotion.getText());
//				System.out.println(choiceAnneeScolaire.getValue());
////				
//				try {
//					ChargeurArbreBinaire nouvelleEntree = new ChargeurArbreBinaire(
//							textFieldNom.getText(),
//							textFieldPrenom.getText(),
//							departementBox.getValue(),
//							textFieldPromotion.getText(), 
//							choiceAnneeScolaire.getValue());
//					
//				} catch (IOException e) {
//					// TODO Auto-generated catch block
//					e.printStackTrace();
//				}
		...
		btnDocumentation.setTranslateY(0);
		...
		vboxGauche.getChildren().addAll(lblFormulaireStagiaire, espace, lblNom, textFieldNom, lblPrenom,
				...
				spinnerAnneeScolaire, boutonAjouter, boutonModifier, boutonSupprimer, btnImprimer);
